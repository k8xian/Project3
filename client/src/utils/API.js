...
export default {
  ...
  ******************************************/
  getNewFortniteData: function (userData) {
    return axios.put(`/api/getNewFortniteData/${userData.userAccountName}`, userData);
  },
  getNewHalo5Data: function (userData) {
    return axios.put(`/api/getNewHalo5Data/${userData.userAccountName}`, userData);
  },
  getNewLOLData: function (userData) {
    return axios.put(`/api/getNewLOLData/${userData.userAccountName}`, userData);
  },
  getNewOverwatchData: function (userData) {
    return axios.put(`/api/getNewOverwatchData/${userData.userAccountName}`, userData);
  },
  /******************************************
